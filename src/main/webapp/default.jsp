...
<div class="subTopMenu" id="subTopMenu">
	...
	<table width="450" cellpadding="0" cellspacing="0" height="20">
	      <tr>
	        ...
	        <td align="left" width="190"><span class="marg_lef5" style="vertical-align:middle;">:</span></td>
	        <td align="right"><img src="${ctx}/images/LT_footer_i2.jpg" title="登录时间" align="middle" /></td>
	        <td align="left"><span class="marg_lef5" style="vertical-align:middle;">:${sessionScope.securityContext.loginTime}</span></td>
	      </tr>
	    </table></td></tr>
	</table>
	 </div>
