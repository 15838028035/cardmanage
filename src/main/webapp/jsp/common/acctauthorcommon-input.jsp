  ...
  <body>
	...
	<table align="center">
		<tr>
			...
			<td>
				<div class="window_button marg_lef10 float_lef"><input type="button" id="ofbizAuthor" class="window_button_centerInput window_button_centerInput1" value="<s:text name='author.tips.entrustauthor'></s:text>" onclick="ofbizAuthor();"/></div>
			</td>
			<td>
				<div class="window_button marg_lef10 float_lef"><input type="button" id="cancelEntrust" class="window_button_centerInput window_button_centerInput1" value="<s:text name='author.tips.revokeentrustauthor'></s:text>" onclick="releaseAuthor();" disabled=disabled/></div>
			</td>
			<td>
				<div class="window_button marg_lef10 float_lef"><input type="button" id="refresh" class="window_button_centerInput window_button_centerInput1" value="<s:text name='common.tips.refresh'></s:text>" onclick="refresh();"/></div>
			</td>
			<td>
				<div class="window_button marg_lef10 float_lef"><input type="button" id="revokeAuthor" class="window_button_centerInput window_button_centerInput1" value="<s:text name='common.options.cancel'></s:text>" onclick="closeWindow();"/></div>
			</td>
		</tr>
	</table>
  	...
  	<table>
		...
		<tr>
			...
			<td width="100" align="right">
				<div class="window_button marg_lef10 float_rig"><input type="submit" class="window_button_centerInput window_button_centerInput1" id="authorButton1" value="<s:text name='common.options.save'></s:text>"/></div>
			</td>
			<td width="500" align="left">
				<div class="window_button marg_lef10 float_lef"><input type="button" class="window_button_centerInput window_button_centerInput1" value="<s:text name='common.options.cancel'></s:text>" onclick="cancelOperate();"/></div>
			</td>
		</tr>
	</table>
	</form>
...
<div id="editAu2" style="display: none;">
  	...
  	<table>
		...
		<tr>
			<td width="10">&nbsp;</td>
			<td width="100" align="right">
				<div class="window_button marg_lef10 float_rig"><input type="submit" id="authorButton2" class="window_button_centerInput window_button_centerInput1" value="<s:text name='common.options.save'></s:text>"/></div>
			</td>
			<td width="500" align="left">
				<div class="window_button marg_lef10 float_lef"><input type="button" class="window_button_centerInput window_button_centerInput1" value="<s:text name='common.options.cancel'></s:text>" onclick="cancelOperate();"/></div>
			</td>
