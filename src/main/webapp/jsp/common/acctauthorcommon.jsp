...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <%} %>
  ...
  <body>
	...
	<table align="center">
		<tr>
			<td><div class="window_button marg_lef10 float_lef"><input type="button" id="addAuthor" class="window_button_centerInput window_button_centerInput1" value="<s:text name='author.tips.addauthor'></s:text>" onclick="addAuthor();"/></div></td>
			<td><div class="window_button marg_lef10 float_lef"><input type="button" id="editAuthor" class="window_button_centerInput window_button_centerInput1" value="<s:text name='author.tips.editauthor'></s:text>" onclick="editAuthor();"/></div></td>
			<td><div class="window_button marg_lef10 float_lef"><input type="button" id="revokeAuthor" class="window_button_centerInput window_button_centerInput1" value="<s:text name='author.tips.revokeauthor'></s:text>" onclick="revokeAllAuthor();"/></div></td>
		</tr>
	</table>
	...
	<table>
            	...
            	<table>
					<tr>
						...
						<td align="left" class="font_wei" id="testButton">
							<div class="window_button" id="TestHostConnectDiv">
		...
		<tr>
			...
			<td width="90" align="right">
				<div class="window_button marg_lef10 float_rig"><input type="button" class="window_button_centerInput window_button_centerInput1" id="submitauthor" value="<s:text name='common.options.save'></s:text>"/></div>
			</td>
			<td width="500" align="left">
