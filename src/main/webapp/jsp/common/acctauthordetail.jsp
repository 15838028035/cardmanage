				...
				<div class="contain_wrap">
					<div class="contain_search">
						...
						<table>
							...
							<tr>
								<td colspan="2">
					             	<div class="window_button float_lef marg_lef10"><input type="button" class="window_button_centerInput window_button_centerInput1"  value="<s:text name='common.options.ok' />" id="quit"/></div>				
								</td>
							</tr>
						</table>
		  			</div>
